    ...
    try {
      ...
      const { error } = await supabase
        ...
        .upsert({
          ...
          linkedin_url: values.linkedinUrl || null,
          additional_notes: values.additionalNotes || null,
          // @ts-ignore - These fields exist in the database but are not in the generated types
      ...
      <div className="w-full max-w-7xl mx-auto space-y-6 p-6">
        ...
        {isEditing ? (
          ...
          <>
            {profile && (
              <>
                {/* Founder view: new modern layout */}
                {profile.user_type === 'founder' && founderDetails && (
                  <div className="space-y-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          ...
                          {founderDetails.linkedin_url && (
                            <div>
                              ...
                              <a href={founderDetails.linkedin_url} target="_blank" rel="noopener noreferrer" 
                      ...
                      <div className="p-6">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                          <div>
                            ...
                            <div className="text-lg text-gray-900 font-semibold">{founderDetails.industry}</div>
                          </div>
                          <div>
                            <div className="text-sm font-medium text-gray-500 mb-2">Company Description</div>
                            <div className="text-base text-gray-900 leading-relaxed bg-gray-50 rounded-lg p-4">
                              {founderDetails.company_description || <span className="text-gray-400 italic">No description provided</span>}
                            </div>
                          </div>
                          <div>
                            <div className="text-sm font-medium text-gray-500 mb-2">Company Website</div>
                            {founderDetails.company_website_url ? (
                              <a href={founderDetails.company_website_url} target="_blank" rel="noopener noreferrer" 
                                 className="text-base text-blue-600 hover:text-blue-800 font-medium hover:underline transition-colors">
                                {founderDetails.company_website_url}
                              </a>
                        ...
                        <div className="mt-8 pt-6 border-t border-gray-100">
                          <div className="text-sm font-medium text-gray-500 mb-3">Most Recent Round Raised</div>
                          <div className="text-base text-gray-900">
                            {founderDetails.last_round_raised || <span className="text-gray-400 italic">Not specified</span>}
                          </div>
                        </div>
                        <div className="mt-8 pt-6 border-t border-gray-100">
                          <div className="text-sm font-medium text-gray-500 mb-3">Current Annual Revenue</div>
                          <div className="text-base text-gray-900">
                            {founderDetails.current_revenue || <span className="text-gray-400 italic">Not specified</span>}
                          </div>
                        </div>
                        <div className="mt-8 pt-6 border-t border-gray-100">
                          <div className="text-sm font-medium text-gray-500 mb-3">Next Raise Planned</div>
                          <div className="text-base text-gray-900">
                            {founderDetails.next_raise_planned || <span className="text-gray-400 italic">Not specified</span>}
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    {(founderDetails.additional_notes || '').trim() && (
                      <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                      ...
                      <div className="p-6">
                        ...
                        <div className="mt-8 pt-6 border-t border-gray-100">
                          ...
                          <div className="text-base text-gray-900 leading-relaxed">
                            {(investorDetails as any).leads_deals || <span className="text-gray-400 italic">Not specified</span>}
                          </div>
                        </div>
                        <div className="mt-8 pt-6 border-t border-gray-100">
                        ...
                        <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
                          ...
                          <div>
                            ...
                            <div className="text-base text-gray-900 bg-gray-50 rounded-lg p-3 min-h-[80px]">
                              {(investorDetails as any).revenue_criteria || <span className="text-gray-400 italic">Not specified</span>}
                            </div>
                          </div>
                          {/* Business Models */}
                          <div>
                            ...
                            <div className="flex flex-wrap gap-2">
                              {Array.isArray((investorDetails as any).business_models) && (investorDetails as any).business_models.length > 0 ? 
                                (investorDetails as any).business_models.map((model: string, index: number) => (
                                  <span key={index} className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-purple-100 text-purple-800">
                                    {model}
                                  </span>
                                )) : 
